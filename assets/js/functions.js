...
$(document).ready(function() {
  ...
  $('a[href*="#"]:not([href="#0"])').click(function(ev) {
	...
	if ($(window).width() > 991) {  
	  ...
	  /* testimonial */
	  var $testimonialTrigger = $('.testimonial'),
	  		$testimonialPost = $('.testimonial__post'),
	  		$testimonialButton = $('.testimonial__view-more--el'),
	  		testimonialTl = new TimelineLite();
	  		
	  testimonialTl
	  	.staggerFrom($testimonialPost, 0.8, {opacity: 0, ease: Power1.easeOut}, 0.4)
	  	.from($testimonialButton, 0.8, {opacity: 0, ease: Power1.easeOut}, '-=0.2');
	  	
	  var testimonialScene = new ScrollMagic.Scene({
		  triggerElement: $testimonialTrigger,
		  reverse: false
	  })
